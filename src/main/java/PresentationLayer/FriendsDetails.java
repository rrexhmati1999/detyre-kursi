...
public class FriendsDetails extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel4.setText("My Friend's Courses List");

        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
            },
            new String [] {
                "Course ID", "Friend ID", "Start Date", "End Date"
            }
        ) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FriendsDetails.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
